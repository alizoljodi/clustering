...
if __name__ == "__main__":
    ...
    if args.exp_name == "resnet18":
        for seed in seeds:
            for i in range(4):
                os.system(f"python main_imagenet_tsne.py --data_path /home/alz07xz/imagenet --arch resnet18 --seed {seed} --n_bits_w {w_bits[i]} --n_bits_a {a_bits[i]} --weight 0.01 --T 4.0 --lamb_c 0.02")
                time.sleep(0.5)
